...
`発揮したバリュー`  
Facebook の広告データ取り込みや Elastic Transcoder を使った動画のトランスコードなど、社内・Web に情報が少ない実装に対しても粘り強く対処し、問題を解決し知見を蓄積してきました。

スピード感を持って安全にデリバリーし続けられるよう、プロダクト立ち上げ初期の段階から自動テスト・CICD を整備し、80-90％のカバレッジを維持してきました。同時に RSpec の知見も社内に蓄積し、DOGADOZO 以外のプロダクトにもテストを普及させていきました。

経理や広報など開発以外のメンバーとのプロダクトに対する知識ギャップを埋めるため、仕様ドキュメント作成やデモ動画の撮影などを自主的にやっていました。
...
- 1 つ 1 つの機能が「なぜ必要なのか」を納得感をもって開発したい
