...
#### 自社サービス開発
概要：動画プラットフォーム「[DOGADOZO](http://dogadozo.com/)」の新規立ち上げ。
...
既存プロダクトでテストが書かれていなかったことで開発が属人化し効率も落ちている状況を課題と考え、当プロダクトでは立ち上げ期から一貫してテストカバレッジを80-90%の状態を維持し、CIでの自動テスト・デプロイも導入しました。結果として2年間大きなも障害なく、数日程度でリリースサイクルを回すことができビジネスの仮説検証のスピードをあげることができました。
...
自社サービス、クライアントワークの両方でビジネスサイドからの要求を汲み取り、それらをどう要件としてまとめるなどのコミュニケーションがとれます。非エンジニアであるビジネスサイドからの要望を漏れなく齟齬なく整理し、開発チームに展開するため、要件整理の前には必ず5W1Hフォーマットを整理する、過去に認識齟齬が生じた箇所はストックして必ず聞くようにするなど工夫をし、手戻りの少ないスピード感を持った開発を推進してきました。
