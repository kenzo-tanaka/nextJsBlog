...
スピード感を持って安全にデリバリーし続けられるよう、プロダクト立ち上げ初期の段階から自動テスト・CICD を整備し、80-90％のカバレッジを維持してきました。同時にテストの知見も社内に蓄積し、DOGADOZO 以外のプロダクトにもテストを普及させていきました。

経理や広報など開発以外のメンバーとのプロダクトに対する知識ギャップを埋めるため、ドキュメントの整備やデモ動画の撮影などを自主的にやっていました。
